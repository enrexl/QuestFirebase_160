...
import com.firebase.firestore.R
...
import com.firebase.firestore.ui.viewmodel.HomeViewModel
...
fun HomeStatus(
    ...
    when (homeUiState) {
        ...
        is HomeUiState.Error -> OnErrir(retryAction, modifier = modifier.fillMaxSize(),
...
@Composable
fun OnErrir(retryAction: () -> Unit, modifier: Modifier = Modifier, message : String) {
    Column(
        modifier = modifier,
        verticalArrangement = Arrangement.Center,
        horizontalAlignment = Alignment.CenterHorizontally
